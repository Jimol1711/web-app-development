...
function agregarSelector() {
    if (selectCount < 3) {
        ...
        artesaniaSelecter.appendChild(nuevoSelect);
        selectCount++;
        ...
        if (selectCount === 3) {
            ...
            artesaniaSelecter.removeEventListener("change", agregarSelector);
        }
    }
}
...
artesaniaSelecter.addEventListener("change", agregarSelector);
...
const validateForm = () => {
    ...
    let region = myForm["region"].textContent;
    let comuna = myForm["comuna"].textContent;
    let typeartesania = myForm["artesania"].textContent;
    let files = myForm["artesania_files"].files;
